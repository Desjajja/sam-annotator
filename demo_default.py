...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        output_text = gr.Textbox(label="Selected position")
    ...
    def get_select_coords(img, tolerance, evt: gr.SelectData):
        ...
        print(evt)
        out_text = f"({evt.index[0]}, {evt.index[1]})"
        return out_img, out_text

    input_img.select(get_select_coords, [input_img, tolerance], [output_img, output_text])
